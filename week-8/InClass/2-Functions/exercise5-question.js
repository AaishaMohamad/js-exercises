...
function refactor(fName,sName){
    let concat= "Hello " + fName + " " + sName;
    return concat
}
...
let greeting1 = refactor(firstName1,surname1);

let firstName2 = "Eric";
let surname2 = "Yuan";
// Change the line below to call your function!
let greeting2 = refactor(firstName2,surname2);

let firstName3 = "Jeff";
let surname3 = "Bezos";
// Change the line below to call your function!
let greeting3 = refactor(firstName3, surname3);
